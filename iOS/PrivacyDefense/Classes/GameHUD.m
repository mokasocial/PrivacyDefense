...
//        NSString *tower1 = @"MachineGunTurret.png";
//        NSString *tower2 = @"MachineGunTurret.png";
//        NSString *tower3 = @"MachineGunTurret.png";
//        NSString *tower4 = @"MachineGunTurret.png";
        
  
        //Using only 3 towers
        
        NSString *tower1 = @"Teacher32.png";
        NSString *tower2 = @"Judge32.png";
        NSString *tower3 = @"Lawyer32.png";

        
        movableSprites = [[NSMutableArray alloc] init];
        NSArray *images = [NSArray arrayWithObjects:tower1, tower2, tower3, nil];       
