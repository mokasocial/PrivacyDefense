...
public class TowerType {
	...
	public static TowerType JUDGE = new TowerType("JUDGE", 100, new Vector2( 9*16, 1*16));
	public static TowerType FIREWALL = new TowerType("FIREWALL", 200, new Vector2( 10*16, 1*16));
	public static TowerType TEACHER = new TowerType("TEACHER", 300, new Vector2( 10*16, 1*16));
	public static TowerType LAWSUIT = new TowerType("LAWSUIT", 400, new Vector2( 10*16, 1*16));
